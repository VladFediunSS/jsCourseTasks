...
class WarPlane extends Plane{
    constructor(model, fuelSupply, fuelConsumption, missiles, aerodynamicsCoef){
        super(model, fuelSupply, fuelConsumption);
        this.missiles = missiles;
        this.aerodynamicsCoef = aerodynamicsCoef;
    }

    calcFlightRange(){
        return (this.fuelSupply/this.fuelConsumption * 100) * 1.2;
    }
}
